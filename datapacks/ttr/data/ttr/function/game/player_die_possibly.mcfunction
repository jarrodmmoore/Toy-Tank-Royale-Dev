...
#self-damaged is turned off? don't hurt ourselves, then
...
execute if score #wasFriendly value matches 0 if entity @s[tag=!extra_life,tag=!livin,tag=!hitThisTick] run function ttr:game/player_die_take_damage
execute if score #wasFriendly value matches 0 if entity @s[tag=extra_life,tag=!hitThisTick] run function ttr:game/player_still_alive
execute if score #wasFriendly value matches 1 if entity @s[tag=!hitThisTick] if score #opt_friendlyfire value matches 1 run function ttr:game/player_die_stunned
execute if score #wasFriendly value matches 1 if entity @s[tag=!hitThisTick] if score #opt_friendlyfire value matches 2 if entity @s[tag=!extra_life,tag=!livin,tag=!hitThisTick] run function ttr:game/player_die_take_damage
execute if score #wasFriendly value matches 1 if entity @s[tag=!hitThisTick] if score #opt_friendlyfire value matches 2 if entity @s[tag=extra_life,tag=!hitThisTick] run function ttr:game/player_still_alive

...
#can't have red or blue in our paint job! we're not affiliated with red or blue team
execute if score #global color_1 matches 2 run scoreboard players set #global value 0
execute if score #global color_2 matches 2 run scoreboard players set #global value 0
execute if score #global color_1 matches 3 run scoreboard players set #global value 0
execute if score #global color_2 matches 3 run scoreboard players set #global value 0
...
#up to 63 attempts
execute if entity @s[tag=need_color] if score #global recursions matches 63 run function ttr:game/colors/adopt_default_colors
execute if entity @s[tag=need_color] if score #global recursions matches ..62 run function ttr:game/colors/try_mixed_colors_teamless
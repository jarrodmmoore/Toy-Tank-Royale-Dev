...
execute if score #want_color_1 value matches 0 run scoreboard players add #global color_1 1
execute if score #want_color_2 value matches 0 run scoreboard players add #global color_2 1
...
execute if score #global recursions matches ..7 if entity @s[tag=need_color] run function ttr:game/colors/try_custom_colors
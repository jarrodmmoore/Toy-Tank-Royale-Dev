...
execute as @e[limit=1,sort=nearest,tag=gold_crown,type=item_display] run tp @s ~ ~1.2 ~ 0 0
...
#execute at @s positioned ~ 29 ~ run summon area_effect_cloud ~ ~ ~ {custom_particle:{type:"block",block_state:{id:"air"}},WaitTime:0,Duration:2,Tags:["lastCrownLocation"]}
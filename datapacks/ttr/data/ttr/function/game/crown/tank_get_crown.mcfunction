...
execute if entity @s[tag=!player_ded] at @s as @e[limit=1,sort=nearest,tag=gold_crown,type=item_display] run tp @s ~ ~1.2 ~ 0 0
execute if entity @s[tag=player_ded] at @s as @e[limit=1,sort=nearest,tag=gold_crown,type=item_display] run tp @s ~ ~-4 ~ 0 0

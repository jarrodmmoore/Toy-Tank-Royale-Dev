...
execute if entity @s[tag=!failed] run tag @s remove blueTeam
execute if entity @s[tag=!failed] run tag @s add redTeam
execute if entity @s[tag=!failed] run scoreboard players set @s teamID 1

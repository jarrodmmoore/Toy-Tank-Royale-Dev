...
execute if entity @s[scores={aiDelayAim=..0}] facing entity 000001a4-0000-0000-0000-000000000045 eyes rotated ~ 0 run tp @e[limit=1,sort=nearest,tag=my_model_2,type=item_display,distance=..4] ~ ~0.5 ~ ~ ~
execute if entity @s[scores={aiDelayAim=1..}] run tp @e[limit=1,sort=nearest,tag=my_model_2,type=item_display,distance=..4] ~ ~-1.2 ~

#scoreboard players set #recursions value 8
#execute rotated as @e[limit=1,sort=nearest,tag=my_model_2,type=item_display] rotated ~ 0 positioned ~ ~.5 ~ run function ttr:movement/aim/show_aim

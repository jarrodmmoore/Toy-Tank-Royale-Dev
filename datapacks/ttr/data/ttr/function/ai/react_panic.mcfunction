...
execute facing entity @e[limit=1,sort=nearest,type=marker,tag=panic_projection] eyes rotated ~ 0 run tp @e[limit=1,sort=nearest,tag=my_model_2,distance=..4] ~ ~0.5 ~ ~ ~

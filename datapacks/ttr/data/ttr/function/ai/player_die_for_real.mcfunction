...
scoreboard players operation #drop_coins value = @s aiCoins
scoreboard players operation #drop_coins value /= #2 value

#remove 1/2 of our coins score
scoreboard players operation @s aiCoins -= #drop_coins value
...
execute at @s run function ttr:random/powerups/dead_tank_spawn_coins
...
execute if score #opt_gamemode value matches 7 if score #infection_state value matches 2 unless entity @s[tag=redTeam] run function ttr:ai/respawn_in_place
execute if score #opt_gamemode value matches 7 if score #infection_state value matches 2 unless entity @s[tag=redTeam] run function ttr:ai/switch_to_red_infect
...
execute at @s as 00000012-0000-0001-0000-000000000002 run function ttr:control/char_model_flash_body
execute at @s as 00000012-0000-0001-0000-000000000003 run function ttr:control/char_model_flash_head
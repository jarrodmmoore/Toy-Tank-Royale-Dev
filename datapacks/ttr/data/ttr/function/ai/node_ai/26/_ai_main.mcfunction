...
function ttr:ai/node_ai/26/char_get_model
...
execute if entity @s[scores={deathTime=..0}] run function ttr:ai/node_ai/26/ai_move_main
...
tag 0000001a-0000-0001-0000-000000000002 remove my_model
tag 0000001a-0000-0001-0000-000000000003 remove my_model_2
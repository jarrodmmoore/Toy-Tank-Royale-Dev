...
#summon model
summon minecraft:armor_stand ~ ~-1 ~ {UUID:[I;47,1,0,2],Tags:["player_model"],Rotation:[0.0f,0.0f],DisabledSlots:4144959,NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:1b,Glowing:0b}
execute as 0000002f-0000-0001-0000-000000000002 run function ttr:control/body_get_model

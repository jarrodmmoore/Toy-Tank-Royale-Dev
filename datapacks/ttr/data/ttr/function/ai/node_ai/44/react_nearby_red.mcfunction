...
execute if entity @s[scores={shootCooldown=..0,aiSkill=..2}] positioned ^ ^ ^2 if entity @e[distance=..2,tag=!redTeam,tag=!self101,tag=p_can_hit,tag=!player_ded,tag=!mine] run tag @s add panic
execute if entity @s[scores={shootCooldown=..0,aiSkill=3}] positioned ^ ^ ^1 if entity @e[distance=..2,tag=!redTeam,tag=!self101,tag=p_can_hit,tag=!player_ded,tag=!mine] run tag @s add panic
execute if entity @s[scores={shootCooldown=..0,aiSkill=4}] positioned ^ ^ ^ if entity @e[distance=..3,tag=!redTeam,tag=!self101,tag=p_can_hit,tag=!player_ded,tag=!mine] run tag @s add panic
execute if entity @s[scores={shootCooldown=..0,aiSkill=5..}] positioned ^ ^ ^ if entity @e[distance=..4,tag=!redTeam,tag=!self101,tag=p_can_hit,tag=!player_ded,tag=!mine] run tag @s add panic

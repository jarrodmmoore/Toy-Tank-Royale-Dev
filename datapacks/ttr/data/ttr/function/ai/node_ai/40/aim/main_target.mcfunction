...
execute if entity @s[scores={aiDelayAim=..0}] facing entity 000001a4-0000-0000-0000-000000000045 eyes rotated ~ 0 run tp 00000028-0000-0001-0000-000000000003 ~ ~0.5 ~ ~ ~
execute if entity @s[scores={aiDelayAim=1..}] run tp 00000028-0000-0001-0000-000000000003 ~ ~0.5 ~

#scoreboard players set #recursions value 8
#execute rotated as 00000028-0000-0001-0000-000000000003 rotated ~ 0 positioned ~ ~.5 ~ run function ttr:movement/aim/show_aim

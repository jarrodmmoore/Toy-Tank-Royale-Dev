...
execute if score @s aiReactTime matches ..0 at 00000027-0000-0001-0000-000000000003 run function ttr:ai/node_ai/39/react_nearby_try

#shoot pellets n stuff
function ttr:ai/shoot_cooldown
scoreboard players remove @s aiThinkCooldown 1
execute if score @s shootCooldown matches ..0 rotated as 00000027-0000-0001-0000-000000000003 rotated ~ 0 positioned ~ ~-1 ~ run function ttr:ai/shoot/think

#tank aim
execute if score @s aiLookID matches 1.. run function ttr:ai/node_ai/39/aim/main_target
execute unless score @s aiLookID matches 1.. run function ttr:ai/node_ai/39/aim/main_no_target

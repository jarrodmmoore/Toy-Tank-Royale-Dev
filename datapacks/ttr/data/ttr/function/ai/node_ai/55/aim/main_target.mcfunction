...
execute if entity @s[scores={aiDelayAim=..0}] run tp 00000037-0000-0001-0000-000000000003 ~ ~-1.2 ~ facing entity 000001a4-0000-0000-0000-000000000045 eyes
execute if entity @s[scores={aiDelayAim=1..}] run tp 00000037-0000-0001-0000-000000000003 ~ ~-1.2 ~

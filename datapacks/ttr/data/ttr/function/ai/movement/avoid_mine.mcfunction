...
execute as @e[limit=1,sort=nearest,tag=mine,type=armor_stand] at @s store result score #avoid_x value run data get entity @s Pos[0] 1
execute as @e[limit=1,sort=nearest,tag=mine,type=armor_stand] at @s store result score #avoid_z value run data get entity @s Pos[2] 1

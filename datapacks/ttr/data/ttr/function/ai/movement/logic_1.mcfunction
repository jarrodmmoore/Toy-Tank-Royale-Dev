#logic 1 = go towards target coordinates (unless stopped by a wall or something)
...
execute unless score @s inputDir = @s inputDirPrev run scoreboard players set @s aiMoveTime 4
...
execute unless score @s aiMoveTime matches 1.. if score #dx value matches 0 if score #dz value matches 1.. run scoreboard players set @s inputDir 1
execute unless score @s aiMoveTime matches 1.. if score #dx value matches ..-1 if score #dz value matches 1.. run scoreboard players set @s inputDir 2
execute unless score @s aiMoveTime matches 1.. if score #dx value matches ..-1 if score #dz value matches 0 run scoreboard players set @s inputDir 3
execute unless score @s aiMoveTime matches 1.. if score #dx value matches ..-1 if score #dz value matches ..-1 run scoreboard players set @s inputDir 4
execute unless score @s aiMoveTime matches 1.. if score #dx value matches 0 if score #dz value matches ..-1 run scoreboard players set @s inputDir 5
execute unless score @s aiMoveTime matches 1.. if score #dx value matches 1.. if score #dz value matches ..-1 run scoreboard players set @s inputDir 6
execute unless score @s aiMoveTime matches 1.. if score #dx value matches 1.. if score #dz value matches 0 run scoreboard players set @s inputDir 7
...
#reached target, done
execute if score #dx value matches 0 if score #dz value matches 0 run scoreboard players set @s aiMoveTime 15
execute if score #dx value matches 0 if score #dz value matches 0 run scoreboard players set @s aiLogic 0
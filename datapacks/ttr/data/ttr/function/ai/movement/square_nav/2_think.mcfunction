...
execute if score @s aiSkill matches ..1 if score @s aiSquareTime2 matches 2.. run scoreboard players set #decision value 1
execute if score @s aiSkill matches 2 if score @s aiSquareTime2 matches 1.. run scoreboard players set #decision value 1
...
execute if score @s aiAggression matches ..1 run scoreboard players operation #objective_roll value = @e[limit=1,sort=random,type=marker,tag=randomize,scores={randomize=1..22}] randomize
execute if score @s aiAggression matches 2 run scoreboard players operation #objective_roll value = @e[limit=1,sort=random,type=marker,tag=randomize,scores={randomize=4..23}] randomize
execute if score @s aiAggression matches 3 run scoreboard players operation #objective_roll value = @e[limit=1,sort=random,type=marker,tag=randomize,scores={randomize=8..24}] randomize
execute if score @s aiAggression matches 4.. run scoreboard players operation #objective_roll value = @e[limit=1,sort=random,type=marker,tag=randomize,scores={randomize=10..25}] randomize

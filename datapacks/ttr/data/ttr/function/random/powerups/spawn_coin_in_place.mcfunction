...
#spawn the item
execute unless score #force_turtles value matches 1 positioned ~ ~-1.5 ~ run summon armor_stand ~ ~ ~ {Tags:["item_chest","set_item","coin","gold_coin","no_poof"],Small:1b,Invulnerable:1b,Invisible:1b,NoGravity:1b,DisabledSlots:4144959,equipment:{head:{id:"minecraft:black_dye",count:1,components:{"minecraft:item_model":"ttr/pickups/coin"}}}}

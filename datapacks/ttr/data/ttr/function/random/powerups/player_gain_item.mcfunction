execute if score #got_item value matches -1 run scoreboard players add @s coins 50
execute if score #got_item value matches 0 run scoreboard players add @s coins 1
execute if score #got_item value matches 1 run scoreboard players add @s coins 5
...
execute if score #got_item value matches 13 run effect give @s regeneration 40 10 false
...
#update hotbar immediately
#function ttr:game/hotbar/check_hotbar_0
execute if score #got_item value matches 2 run function ttr:game/hotbar/check_hotbar_1
execute if score #got_item value matches 3 run function ttr:game/hotbar/check_hotbar_2
execute if score #got_item value matches 4 run function ttr:game/hotbar/check_hotbar_3
execute if score #got_item value matches 5 run function ttr:game/hotbar/check_hotbar_4
execute if score #got_item value matches 6 run function ttr:game/hotbar/check_hotbar_5
execute if score #got_item value matches 7 run function ttr:game/hotbar/check_hotbar_6
execute if score #got_item value matches 8 run function ttr:game/hotbar/check_hotbar_7
execute if score #got_item value matches 9 run function ttr:game/hotbar/check_hotbar_8
scoreboard players set #item_id value 6

scoreboard players set #recursions value 15
function ttr:random/powerups/spreadplayer_aec

#spawn the item
execute as @e[limit=1,tag=item_spawnpoint,type=marker] at @s positioned ~ ~-1.5 ~ run summon armor_stand ~ ~ ~ {Tags:["item_chest","set_item","weapon"],Small:1b,Invulnerable:1b,Invisible:1b,NoGravity:1b,DisabledSlots:4144959,equipment:{head:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;442139050,1046628105,-1197599574,1385048593],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTQ5ODg2YTU3YjVlNWIxMzZkZGIyYTk0NzkxZjliN2U3MzE2ZTVkODY0NmYxN2EwNDdkNWY5NWE3NDg0Y2IifX19"}]}}}}}
...
scoreboard players set @e[limit=1,tag=set_item,type=armor_stand] itemID 6

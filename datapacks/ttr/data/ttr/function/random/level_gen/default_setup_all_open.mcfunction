scoreboard players set #area_1_active value 1
scoreboard players set #area_2_active value 1
scoreboard players set #area_3_active value 1
...
scoreboard players set #area_7_active value 1
scoreboard players set #area_8_active value 1
scoreboard players set #area_9_active value 1
...
scoreboard players set #gen_min_players value 8
scoreboard players set #gen_max_players value 9
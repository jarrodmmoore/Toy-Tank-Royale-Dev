...
#player_char
tag 00000023-0000-0000-0000-000000000001 add my_char
scoreboard players set 00000023-0000-0000-0000-000000000001 lifespan 10

#visualization
scoreboard players operation #death_state value = @s deathTime
execute as 00000023-0000-0000-0000-000000000001 at @s run function ttr:control/node/35/char_get_model
...
#still alive!!
execute if entity @s[tag=livin] as 00000023-0000-0000-0000-000000000001 at @s run function ttr:game/tank_still_alive

#took damage, among other things
execute if entity @s[tag=tookDamage] as 00000023-0000-0000-0000-000000000001 at @s run function ttr:game/tank_took_damage
execute if entity @s[tag=stunned] as 00000023-0000-0000-0000-000000000001 at @s run function ttr:game/tank_stunned

#reload if player char is missing
execute if entity 00000023-0000-0000-0000-000000000001 at @s run scoreboard players set @s charTimeout 0
...
execute as 00000023-0000-0000-0000-000000000004 at @s if entity @a[distance=..5,tag=pl_self] run scoreboard players set @s lifespan 20
execute as 00000023-0000-0000-0000-000000000005 at @s if entity @a[distance=..5,tag=pl_self] run scoreboard players set @s lifespan 20

#camera
function ttr:control/node/35/camera/cam_main

#movement here
#execute if entity @e[limit=1,tag=my_char,tag=!noMove] run function ttr:control/node/35/movement/_move_main
function ttr:control/node/35/movement/_move_main
...
tag 00000023-0000-0000-0000-000000000001 remove my_char
...
#execute if entity @s[scores={lastDirection=1}] unless score global oTimer matches 9 as 00000022-0000-0000-0000-000000000002 run data merge entity @s {Rotation:[0.0f]}

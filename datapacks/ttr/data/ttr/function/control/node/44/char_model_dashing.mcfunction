...
execute as @e[limit=1,sort=nearest,tag=set_image,tag=after_image_body,type=item_display,distance=..3] at 0000002c-0000-0000-0000-000000000002 run tp @s ~ ~-.1 ~ ~ ~
execute as @e[limit=1,sort=nearest,tag=set_image,tag=after_image_head,type=item_display,distance=..3] at 0000002c-0000-0000-0000-000000000003 run tp @s ~ ~-.1 ~ ~ ~

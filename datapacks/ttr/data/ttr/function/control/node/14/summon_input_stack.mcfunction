...
summon armor_stand ~ ~1 ~ {UUID:[I;14,0,0,4],Tags:["input","input_base","tp_up","setlife"],Invulnerable:1b,NoGravity:1b,Glowing:0b,Invisible:1b,Small:1b,Passengers:[{id:"minecraft:minecart",UUID:[I;14,0,0,5],Invulnerable:1b,Tags:["input","input_minecart","setlife"]}]}

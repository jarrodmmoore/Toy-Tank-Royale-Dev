...
summon item_display ~ ~1 ~ {interpolation_duration:1,teleport_duration:2,UUID:[I;1,0,0,4],Tags:["input","input_base","tp_up","setlife"],Passengers:[{id:"minecraft:minecart",UUID:[I;1,0,0,5],Invulnerable:1b,Tags:["input","input_minecart","setlife"]}]}

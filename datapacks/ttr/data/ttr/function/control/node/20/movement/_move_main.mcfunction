...
execute as 00000014-0000-0000-0000-000000000001 at @s store result score @s char_x run data get entity @s Pos[0] 1
execute as 00000014-0000-0000-0000-000000000001 at @s store result score @s char_y run data get entity @s Pos[1] 1
execute as 00000014-0000-0000-0000-000000000001 at @s store result score @s char_z run data get entity @s Pos[2] 1
...
execute unless entity @s[scores={haltMovement=1..}] run function ttr:control/node/20/movement/1_grounded
...
#tank aim
execute if entity @s[tag=validRotation,scores={deathTime=..0}] at 00000014-0000-0000-0000-000000000001 run function ttr:control/node/20/movement/aim/main
execute unless entity @s[tag=validRotation] at 00000014-0000-0000-0000-000000000001 run tp 00000014-0000-0000-0000-000000000003 ~ ~-1.2 ~

#shoot pellets n stuff
execute if entity @s[tag=validRotation,scores={carrotInput=1..,shootCooldown=..0}] at 00000014-0000-0000-0000-000000000001 rotated as 00000014-0000-0000-0000-000000000003 rotated ~ 0 positioned ~ ~-1 ~ run function ttr:shoot/_shoot_index

#last direction stored on my_char
scoreboard players operation 00000014-0000-0000-0000-000000000001 lastDirection = @s lastDirection

...
#execute if entity 00000033-0000-0000-0000-000000000004 as @e[limit=1,tag=input_base,type=item_display,tag=!my_base] if score @s playerID = #temporary playerID run function ttr:control/kill_input_base

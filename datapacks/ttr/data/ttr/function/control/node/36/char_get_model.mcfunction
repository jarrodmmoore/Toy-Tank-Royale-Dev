...
execute unless entity 00000024-0000-0000-0000-000000000002 run function ttr:control/node/36/summon_model
execute unless score @s deathTime matches 1.. unless entity 00000024-0000-0000-0000-000000000003 run function ttr:control/node/36/summon_model_head

#note: char_direction is important

#rotate in the direciton we're moving
execute unless score global oTimer matches 9 as 00000024-0000-0000-0000-000000000002 run function ttr:movement/face_movement_direction

#come, tp to me
scoreboard players set 00000024-0000-0000-0000-000000000002 lifespan 10
execute as 00000024-0000-0000-0000-000000000002 rotated as @s run tp @s ~ ~0.5 ~ ~ 0
#head is temporary
scoreboard players set 00000024-0000-0000-0000-000000000003 lifespan 10
#head teleport is handled elsewhere

#execute if score #global dCorrect matches 1 as 00000024-0000-0000-0000-000000000002 at @s run tp @s ~ ~ ~ ~ 45
...
#execute if entity @s[scores={lastDirection=5}] unless score global oTimer matches 9 as 00000024-0000-0000-0000-000000000002 run data merge entity @s {Rotation:[180.0f]}
#execute if entity @s[scores={lastDirection=6}] unless score global oTimer matches 9 as 00000024-0000-0000-0000-000000000002 run data merge entity @s {Rotation:[225.0f]}
#execute if entity @s[scores={lastDirection=7}] unless score global oTimer matches 9 as 00000024-0000-0000-0000-000000000002 run data merge entity @s {Rotation:[270.0f]}
#execute if entity @s[scores={lastDirection=8}] unless score global oTimer matches 9 as 00000024-0000-0000-0000-000000000002 run data merge entity @s {Rotation:[315.0f]}
...
execute if score #tank_dash value matches 1 if entity @s[tag=!player_ded] run function ttr:control/node/36/char_model_dashing
...
execute if entity @s[scores={invulTime=1..}] run function ttr:control/node/36/char_model_flash
execute if score #death_state value matches 1.. run scoreboard players set @s modelFlash -10
execute if entity @s[scores={invulTime=..0,modelFlash=..1}] run function ttr:control/node/36/char_model_flash

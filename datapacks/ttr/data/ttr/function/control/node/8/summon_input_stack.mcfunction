...
kill 00000008-0000-0000-0000-000000000004
kill 00000008-0000-0000-0000-000000000005

#this should probably be executed by a player, summons where the function is run
summon item_display ~ ~1 ~ {interpolation_duration:1,teleport_duration:2,UUID:[I;8,0,0,4],Tags:["input","input_base","tp_up","setlife"],Invulnerable:1b,NoGravity:1b,Glowing:0b,Invisible:1b,Small:1b,Passengers:[{id:"minecraft:minecart",UUID:[I;8,0,0,5],Invulnerable:1b,Tags:["input","input_minecart","setlife"]}]}

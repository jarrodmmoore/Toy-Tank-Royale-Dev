...
execute if entity @s[scores={color_1=3}] run team join color_blue 00000019-0000-0000-0000-000000000002
execute if entity @s[scores={color_1=4}] run team join color_yellow 00000019-0000-0000-0000-000000000002
execute if entity @s[scores={color_1=5}] run team join color_white 00000019-0000-0000-0000-000000000002
execute if entity @s[scores={color_1=6}] run team join color_pink 00000019-0000-0000-0000-000000000002
execute if entity @s[scores={color_1=7}] run team join color_cyan 00000019-0000-0000-0000-000000000002
execute if entity @s[scores={color_1=8}] run team join color_gray 00000019-0000-0000-0000-000000000002

scoreboard players operation 00000019-0000-0000-0000-000000000002 playerID = @s playerID
scoreboard players set 00000019-0000-0000-0000-000000000002 lifespan 20

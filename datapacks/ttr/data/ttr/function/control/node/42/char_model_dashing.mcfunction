...
execute as @e[limit=1,sort=nearest,tag=set_image,tag=after_image_body,type=armor_stand] at 0000002a-0000-0000-0000-000000000002 run tp @s ~ ~-.1 ~ ~ ~
execute as @e[limit=1,sort=nearest,tag=set_image,tag=after_image_head,type=armor_stand] at 0000002a-0000-0000-0000-000000000003 run tp @s ~ ~-.1 ~ ~ ~

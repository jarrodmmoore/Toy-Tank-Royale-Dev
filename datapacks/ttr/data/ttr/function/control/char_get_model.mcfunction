...
execute unless entity @s[scores={left_right=0,up_down=0}] unless score global oTimer matches 9 as @e[limit=1,tag=my_model,type=armor_stand] run tp @s ~ ~ ~ facing ~ ~ ~
...
execute if entity @s[scores={lastDirection=1}] unless score global oTimer matches 9 as @e[limit=1,tag=my_model,type=armor_stand] run data merge entity @s {Rotation:[0.0f]}
execute if entity @s[scores={lastDirection=2}] unless score global oTimer matches 9 as @e[limit=1,tag=my_model,type=armor_stand] run data merge entity @s {Rotation:[45.0f]}
execute if entity @s[scores={lastDirection=3}] unless score global oTimer matches 9 as @e[limit=1,tag=my_model,type=armor_stand] run data merge entity @s {Rotation:[90.0f]}
execute if entity @s[scores={lastDirection=4}] unless score global oTimer matches 9 as @e[limit=1,tag=my_model,type=armor_stand] run data merge entity @s {Rotation:[135.0f]}
execute if entity @s[scores={lastDirection=5}] unless score global oTimer matches 9 as @e[limit=1,tag=my_model,type=armor_stand] run data merge entity @s {Rotation:[180.0f]}
execute if entity @s[scores={lastDirection=6}] unless score global oTimer matches 9 as @e[limit=1,tag=my_model,type=armor_stand] run data merge entity @s {Rotation:[225.0f]}
execute if entity @s[scores={lastDirection=7}] unless score global oTimer matches 9 as @e[limit=1,tag=my_model,type=armor_stand] run data merge entity @s {Rotation:[270.0f]}
execute if entity @s[scores={lastDirection=8}] unless score global oTimer matches 9 as @e[limit=1,tag=my_model,type=armor_stand] run data merge entity @s {Rotation:[315.0f]}
...
execute if score #tank_dash value matches 1 if entity @s[tag=!player_ded] run function ttr:control/char_model_dashing
...
execute if entity @s[scores={invulTime=1..}] run function ttr:control/char_model_flash
execute if score #death_state value matches 1.. run scoreboard players set @s modelFlash -10
execute if entity @s[scores={invulTime=..0,modelFlash=..1}] run function ttr:control/char_model_flash

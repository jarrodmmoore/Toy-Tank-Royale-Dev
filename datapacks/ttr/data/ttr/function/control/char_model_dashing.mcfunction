...
execute as @e[limit=1,sort=nearest,tag=set_image,tag=after_image_body,type=item_display,distance=..3] at @e[limit=1,sort=nearest,tag=my_model] run tp @s ~ ~-.1 ~ ~ ~
execute as @e[limit=1,sort=nearest,tag=set_image,tag=after_image_head,type=item_display,distance=..3] at @e[limit=1,sort=nearest,tag=my_model_2] run tp @s ~ ~-.1 ~ ~ ~

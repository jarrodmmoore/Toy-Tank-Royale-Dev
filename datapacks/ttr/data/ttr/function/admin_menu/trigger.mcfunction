...
execute if score #require_operator value matches 0 run function ttr:admin_menu/__open
execute if score #require_operator value matches 1 run tellraw @s ["",{text:"[",color:"gold",bold:true},{translate:"ttr.menu.click_to_access_options",bold:true,color:"gold",click_event:{action:"suggest_command",command:"/function ttr:admin_menu/__open"},hover_event:{action:"show_text",value:[{text:"/function ttr:admin_menu/__open",color:"yellow"}]}},{text:"]",color:"gold",bold:true},{text:" "},{translate:"ttr.menu.requires_operator",color:"gray"}]

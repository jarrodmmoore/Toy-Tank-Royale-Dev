...
execute as @e[tag=pa3,distance=..1,tag=p_can_hit,tag=!p_self,tag=!player_ded,type=zombie] unless score @s playerID = #pelly_id value run scoreboard players set #hit value 1

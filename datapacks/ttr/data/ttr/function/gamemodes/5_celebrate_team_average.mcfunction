...
execute if score #celebration_time value matches 2 if score #red_average value >= #opt_coinlimit value run scoreboard players set #team_winner value 1
execute if score #celebration_time value matches 2 if score #blue_average value >= #opt_coinlimit value run scoreboard players set #team_winner value 2
...
#fireworks
execute if score #celebration_time value matches 2 if score #team_winner value matches 1 as @e[type=zombie,tag=redTeam,tag=!player_ded] run summon firework_rocket ~ ~1 ~ {LifeTime:20,FireworksItem:{id:"firework_rocket",count:1,components:{"minecraft:fireworks":{flight_duration:1b,explosions:[{shape:"small_ball",colors:[I;16777215],has_trail:1b}]}}}}
execute if score #celebration_time value matches 22 if score #team_winner value matches 1 as @e[type=zombie,tag=redTeam,tag=!player_ded] run summon firework_rocket ~ ~1 ~ {LifeTime:20,FireworksItem:{id:"firework_rocket",count:1,components:{"minecraft:fireworks":{flight_duration:1b,explosions:[{shape:"star",colors:[I;16252672],has_trail:1b}]}}}}
execute if score #celebration_time value matches 42 if score #team_winner value matches 1 as @e[type=zombie,tag=redTeam,tag=!player_ded] run summon firework_rocket ~ ~1 ~ {LifeTime:17,FireworksItem:{id:"firework_rocket",count:1,components:{"minecraft:fireworks":{flight_duration:1b,explosions:[{shape:"creeper",colors:[I;65288]}]}}}}
execute if score #celebration_time value matches 62 if score #team_winner value matches 1 as @e[type=zombie,tag=redTeam,tag=!player_ded] run summon firework_rocket ~ ~1 ~ {LifeTime:17,FireworksItem:{id:"firework_rocket",count:1,components:{"minecraft:fireworks":{flight_duration:1b,explosions:[{shape:"large_ball",colors:[I;16776960],fade_colors:[I;16775930],has_trail:1b,has_twinkle:1b}]}}}}

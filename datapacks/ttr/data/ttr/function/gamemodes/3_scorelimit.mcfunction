...
#execute if score #max_score value >= #opt_scorelimit value run function ttr:gamemodes/3_end
execute unless score #objective_check_delay value matches 1.. if score #max_score value >= #opt_scorelimit value if score #celebration_time value matches 0 run scoreboard players set #celebration_time value 1

#celebrate!
execute if score #celebration_time value matches 1.. run function ttr:gamemodes/3_celebrate
...
execute if score #celebration_time value matches 2 if score #red_coins value > #blue_coins value run scoreboard players set #team_winner value 1
execute if score #celebration_time value matches 2 if score #red_coins value < #blue_coins value run scoreboard players set #team_winner value 2

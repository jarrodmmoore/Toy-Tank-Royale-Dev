...
execute if score #player_count value matches ..1 run function ttr:gamemodes/4_setup

#start game!
execute if score #time2start value matches ..0 if score #elimination_state value matches 1 run function ttr:gamemodes/4_start_match
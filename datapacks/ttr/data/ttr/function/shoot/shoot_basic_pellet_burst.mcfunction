summon armor_stand ^ ^ ^ {NoGravity:1b,Invulnerable:1b,Small:0b,Invisible:1b,NoBasePlate:1b,Tags:["setme","pellet","basic_pellet","basic_pellet_burst","p_can_hit","p_can_pop"],DisabledSlots:4144959,equipment:{head:{id:"minecraft:white_dye",count:1,components:{"minecraft:item_model":"ttr/projectiles/basic_pellet_yellow"}}}}

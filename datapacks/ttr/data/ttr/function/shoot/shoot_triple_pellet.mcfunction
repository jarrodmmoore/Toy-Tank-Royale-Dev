summon armor_stand ^ ^ ^.5 {NoGravity:1b,Invulnerable:1b,Small:0b,Invisible:1b,NoBasePlate:1b,Tags:["setme","setme1","pellet","basic_pellet","basic_pellet_triple","p_can_hit","p_can_pop","dont_spawn_here"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:white_dye",count:1,components:{"minecraft:item_model":"ttr/projectiles/basic_pellet_blue"}}]}
summon armor_stand ^ ^ ^.5 {NoGravity:1b,Invulnerable:1b,Small:0b,Invisible:1b,NoBasePlate:1b,Tags:["setme","setme2","pellet","basic_pellet","basic_pellet_triple","p_can_hit","p_can_pop","dont_spawn_here"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:white_dye",count:1,components:{"minecraft:item_model":"ttr/projectiles/basic_pellet_blue"}}]}
summon armor_stand ^ ^ ^.5 {NoGravity:1b,Invulnerable:1b,Small:0b,Invisible:1b,NoBasePlate:1b,Tags:["setme","setme3","pellet","basic_pellet","basic_pellet_triple","p_can_hit","p_can_pop","dont_spawn_here"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:white_dye",count:1,components:{"minecraft:item_model":"ttr/projectiles/basic_pellet_blue"}}]}
